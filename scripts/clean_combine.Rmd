...
+ )
> 
> # Load each file and extract the fiscal year
...
+         total_obligation  = as.numeric(total_obligation),
+         fiscal_year       = as.integer(fiscal_year)
+     ) %>%
+     select(county_fips, year, fiscal_year, state, agency, naics_code, naics_description, total_obligation) %>%
+     arrange(county_fips, year)
> 
> # Save combined file
> write_csv(contract_all, file.path(contract_path, "fed_contracts_2017_2025.csv"))
>                                                                                                               
> cat("Combined federal contracts saved to: data/cleaned/fed_contracts_2017_2025.csv\n")
